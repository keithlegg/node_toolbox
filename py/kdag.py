...
class dagop(object):
    ...
    def __getNodes( self ):
        #self.KGRAPH.parent_name(cnode,pnode)
    ...
    def prn(self,cname,pname):
        print 'parenting node ' +cname + ' to ' +  pname
        self.__parentNode(cname,pname)
        return dagop(self.DG)
